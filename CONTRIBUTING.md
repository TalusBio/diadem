...
documentation and the code of diadem. **No contribution is too small!** Even
...
3. The Code of Conduct, Release Notes, and this Contributing document are
   markdown files that live in the root of the diadem repository.
...
We welcome contributions to the source code of diadem---particularly
ones that address discussed [issues](https://github.com/TalusBio/diadem/issues).

Contributions to diadem follow a standard GitHub contribution workflow:

1. Create your own fork of the diadem repository on GitHub.

2. Clone your forked diadem repository to work on locally.
...
6. On the GitHub page for you forked repository, click "Pull request" to propose
   adding your changes to diadem.

7. We'll review, discuss, and help you make any revisions that are required. If
   all goes well, your changes will be added to diadem
   in the next release!


### Python code style

The diadem project follows the [PEP 8
...
format code and lint Python code in diadem.
...
2. Navigate to your local copy of the diadem repository and activate the hook:
```bash
pre-commit install
```
